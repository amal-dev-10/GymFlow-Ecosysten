...
import { LayoutDashboard, Inbox, Building2, ArrowUpCircle, BookOpen, Megaphone, Timer, Settings, ChevronLeft, ChevronRight } from 'lucide-react';

export const SUPPORT_TABS = [
  { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard },
  { id: 'tickets', name: 'Tickets', icon: Inbox },
  { id: 'customers', name: 'Customers', icon: Building2 },
  { id: 'escalations', name: 'Escalations', icon: ArrowUpCircle },
  { id: 'kb', name: 'Knowledge Base', icon: BookOpen },
  { id: 'announcements', name: 'Announcements', icon: Megaphone },
  { id: 'sla', name: 'SLA', icon: Timer },
...
export default function SupportCenterTabs({ active, onChange }: { active: SupportTabId; onChange: (id: SupportTabId) => void }) {
