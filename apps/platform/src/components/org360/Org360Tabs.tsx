...
export const ORG360_TABS = [
  { id: 'overview', name: 'Overview', icon: LayoutDashboard },
  { id: 'subscription', name: 'Subscription', icon: CreditCard },
  { id: 'usage', name: 'Usage', icon: Gauge },
  { id: 'branches', name: 'Branches', icon: Building2 },
  { id: 'users', name: 'Organization Users', icon: Users },
  { id: 'features', name: 'Feature Access', icon: ToggleLeft },
  { id: 'billing', name: 'Billing', icon: Receipt },
  { id: 'activity', name: 'Activity Timeline', icon: History },
  { id: 'audit', name: 'Audit Logs', icon: ScrollText },
  { id: 'support', name: 'Support', icon: LifeBuoy },
  { id: 'settings', name: 'Settings', icon: Settings },
] as const;

export type Org360TabId = (typeof ORG360_TABS)[number]['id'];

const SCROLL_STEP = 240;

export default function Org360Tabs({ active, onChange }: { active: Org360TabId; onChange: (id: Org360TabId) => void }) {
