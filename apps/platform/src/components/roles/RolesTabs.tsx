...
import { LayoutDashboard, Grid3x3, Boxes, FileStack, Clock, Users, History, Code2, ChevronLeft, ChevronRight } from 'lucide-react';

export const ROLES_TABS = [
  { id: 'roles', name: 'Roles', icon: LayoutDashboard },
  { id: 'matrix', name: 'Permission Matrix', icon: Grid3x3 },
  { id: 'groups', name: 'Permission Groups', icon: Boxes },
  { id: 'templates', name: 'Role Templates', icon: FileStack },
  { id: 'temporary-access', name: 'Temporary Access', icon: Clock },
  { id: 'assignments', name: 'Role Assignment', icon: Users },
  { id: 'audit', name: 'Audit History', icon: History },
  { id: 'developer', name: 'Developer Preview', icon: Code2 },
] as const;
...
export default function RolesTabs({ active, onChange }: { active: RolesTabId; onChange: (id: RolesTabId) => void }) {
