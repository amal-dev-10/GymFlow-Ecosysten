...
import { LayoutDashboard, Radio, ScrollText, ShieldAlert, Webhook, Download, Archive, Settings, ChevronLeft, ChevronRight } from 'lucide-react';

export const AUDIT_TABS = [
  { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard },
  { id: 'feed', name: 'Activity Feed', icon: Radio },
  { id: 'logs', name: 'Audit Logs', icon: ScrollText },
  { id: 'security', name: 'Security Events', icon: ShieldAlert },
  { id: 'api', name: 'API Activity', icon: Webhook },
  { id: 'exports', name: 'Exports', icon: Download },
  { id: 'retention', name: 'Retention Policies', icon: Archive },
...
export default function AuditCenterTabs({ active, onChange }: { active: AuditTabId; onChange: (id: AuditTabId) => void }) {
